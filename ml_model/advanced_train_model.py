...
class AdvancedDiabetesPredictor:
    ...
    def load_and_preprocess_data(self, filepath=None):
        ...
        if filepath is None:
            ...
            filepath = os.path.join(BASE_DIR, "..", "data", "diabetes.csv")
    ...
    def save_models_and_results(self):
        ...
        joblib.dump(self.best_model, os.path.join(model_dir, "diabetes_model.pkl"))
        ...
        with open(os.path.join(model_dir, f"training_results_{timestamp}.json"), "w") as f:
